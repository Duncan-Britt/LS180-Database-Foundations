...
--
-- Name: weather; Type: TABLE; Schema: public; Owner: duncanbritt
--
...
ALTER TABLE public.weather OWNER TO duncanbritt;

--
-- Data for Name: weather; Type: TABLE DATA; Schema: public; Owner: duncanbritt
--
